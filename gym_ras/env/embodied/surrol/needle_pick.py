...
class NeedlePickMod(NeedlePick):
    ...
    WORKSPACE_LIMITS1 = ((0.50, 0.60), (-0.05-0.02, 0.05+0.02), (0.675+0.009, 0.745))
    ...
    def _env_setup(self):
        ...
        pos_rel = self._needle_pose_rng.uniform(self._init_pose_ratio_low_needle,self._init_pose_ratio_high_needle)
    ...
    def _fsm(self):
        ...
        if (not self._is_grasp_obj()) and (needle_z-self._init_needle_z)>self.SCALING*0.015: # prevent needle is lifted without grasping or grasping unrealisticly
            return "done_fail"
        return "prog_norm"
